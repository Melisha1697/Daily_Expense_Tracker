...
?>
        ...
        function printReport() {
            ...
            nw.document.write(
                '<style>table {border-collapse: collapse; border-spacing: 0;} td, th {border: 1px solid black; padding: 5px;}</style>'
            );
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" id="printable">
                            <h5 align="center" style="color:blue">Received <?php echo ucfirst($rtype); ?> Report from
                                <span style="color:red"><?php echo $fdate ?></span> to <span
                                    style="color:red"><?php echo $tdate ?></span>
                            </h5>
                            <hr />
                            <?php
