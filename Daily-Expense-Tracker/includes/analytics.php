            ...
            <div class="overview-boxes">
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <canvas id="myChart" width="1028" height="632"
                                style="display: block;box-sizing: border-box;height: 493px;width: 822px;"></canvas>
                        </div>
                    ...
                    plugins: [{
                        beforeInit: function(chart, options) {
                            ...
                            for (let i = 0; i < labels.length; i++) {
                                ...
                                colorBox.style.backgroundColor = chart.data.datasets[0]
                                    .backgroundColor[i];
                                const label = document.createElement('div');
                                label.classList.add('chart-legend-label');
                                label.textContent =
                                    `${labels[i]}: ${percentages[i]}% ~ Rs ${expenses[i]}`;
                                item.appendChild(colorBox);
                                item.appendChild(label);
                                legend.appendChild(item);
                            }
                            chart.canvas.parentNode.insertBefore(legend, chart.canvas
                                .nextSibling);
                        }
                    }]
                });
