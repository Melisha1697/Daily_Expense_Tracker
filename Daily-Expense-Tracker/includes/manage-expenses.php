                                    ...
                                    <div class="panel-body">
                                        ...
                                        ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="badge badge-danger"><?php echo $row['category'];?></span>
                                                            </td>
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="manage-expenses.php?delid=<?php echo $row['ID'];?>"
                                                                            data-toggle="modal"
                                                                            data-target="#editExpenseModal"><i
                                                                                class="fas fa-edit"></i> Edit</a>
                                                                        <a class="dropdown-item"
                                                                            href="manage-expenses.php?delid=<?php echo $row['ID'];?>"><i
                                                    ...
                                                    ?>
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="edit-expense-date">Date:</label>
                                                                                        <input type="date"
                                                                                            class="form-control"
                                                                                            id="edit-expense-date"
                                                                                            name="dateexpense"
                                                                                            value="<?php echo $row['ExpenseDate']; ?>">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="edit-expense-category">Category:</label>
                                                            ...
                                                            ?>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="edit-expense-cost">Cost:</label>
                                                                                        <input type="number"
                                                                                            class="form-control"
                                                                                            id="edit-expense-cost"
                                                                                            name="cost"
                                                                                            value="<?php echo $row['ExpenseCost'];?>">
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label
                                                                                            for="edit-expense-description">Description:</label>
                                                                                        <textarea class="form-control"
                                                                                            id="edit-expense-description"
                                                                                            name="description"><?php echo isset($row) ? $row['Description'] : ''; ?></textarea>
                                                                                    </div>
                                                                                    <input type="hidden"
                                                                                        name="expenseid"
                                                                                        value="<?php echo isset($row) ? $row['ID'] : ''; ?>">
                                                                                </div>
